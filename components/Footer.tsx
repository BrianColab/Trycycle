      ...
      <div className="mx-auto max-w-7xl px-6 py-16">
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-5">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-[0.82rem] leading-relaxed text-muted mb-5">
            ...
            <div className="flex gap-2 mb-4">
              <a
                ...
                className="flex h-8 w-8 items-center justify-center rounded-md transition-opacity duration-150 hover:opacity-70"
                style={{ background: "oklch(0.22 0.03 240)", color: "oklch(1 0 0)" }}
              >
            ...
            <div className="space-y-1.5">
              <a href="mailto:info@trycycle.ca" className="flex items-center gap-2 text-[0.78rem] text-muted hover:text-ivory transition-colors duration-150">
                info@trycycle.ca
              </a>
              <a href="tel:+16132740001" className="flex items-center gap-2 text-[0.78rem] text-muted hover:text-ivory transition-colors duration-150">
                613.274.0001
              </a>
            </div>
